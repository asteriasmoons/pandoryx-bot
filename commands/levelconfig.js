    ...
    if (sub === "set-thresholds") {
      ...
      if (thresholds.length === 0) {
        return interaction.reply({
          content: "Please provide valid numbers.",
          ephemeral: true,
        });
      }
        ...
        embeds: [
          {
            ...
            description: DEFAULT_THRESHOLDS.map(
              (v, i) => `Level ${i + 1}: ${v} messages`
            ).join("\n"),
          },
        ],
      });
